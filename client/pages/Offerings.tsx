...
export default function Offerings() {
  ...
  return (
    <ComingSoonOverlay
      title="Offerings Coming Soon"
      description="We are carefully curating our educational programs. Check back soon for our full list of offerings!"
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {plans.map((plan, idx) => (
                <div
                  key={idx}
                  className={`rounded-2xl overflow-hidden transition-all duration-200 ${plan.highlighted
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <Link
                      to="/onboarding"
                      className={`w-full block text-center py-3 px-6 rounded-lg font-semibold transition-all duration-200 mb-8 ${plan.highlighted
